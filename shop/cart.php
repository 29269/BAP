               ...
               <form action="cart.php" method="get" class="cart-items">
                 <div class="border rounded">
                   <div class="row bg-white">
                       ...
                       <div class="col-md-6">
                           ...
                           <h5 class="pt-2">€14</h5>
                           <small class="text-secondary">maat: S, M, L, XL</small><br>
                           <small class="text-secondary">kleur: Rood, blauw</small><br>
                       ...
                       <button type="butten" class="btn bg-light border round-circle"><i class="fas fa-minus"></i></button>
                       <input type="text" value="1" class="from-control w-25 d-inline">
                       <button type="butten" class="btn bg-light border round-circle"><i class="fas fa-plus"></i></button>
                       </div>
                   </div>  
                 </div>
                ...
                $total = 0;
                    if (isset($_SESSION['cart'])){
                        ...
                        //         if ($row['id'] == $id){
                        //             cartElement($row['tshirts_image'], $row['omschriving'],$row['prijs'], $row['id']);
